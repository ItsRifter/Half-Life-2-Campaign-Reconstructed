...
function LobbyMenu()
	...
	LabelVersionText:SetText("Version: 0.1.3")
	...
	changelogDateText:SetText("31/08/2020 -")
	...
	changelogText:SetText("Fixes:\nFixed difficulty voting\nFixed d2_coast_08\nPlayers can no longer pickup ammo that's over the limit\nVehicles cannot be used when spawned to kill players\nOnly vehicle owners can drive (unless theres a passenger)\nFixed the sand achievement from being achieved regardless")
