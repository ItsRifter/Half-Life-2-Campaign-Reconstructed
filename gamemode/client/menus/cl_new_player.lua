...
function LobbyMenu()
	...
	LabelVersionText:SetText("Version: 0.1.3.5")
	...
	changelogDateText:SetText("01/09/2020 -")
	...
	changelogText:SetText("Fixes:\nAmmo picked up from weapons cannot exceed the ammo limit\nfixed voting system always allowing just one player to vote to pass\nfixed exchanging lambda for negative")
